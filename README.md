...
# How It Works:
  ...
  The dataset used for training is a collection of tweets with labels indicating whether each tweet is "Hate Speech" or "Not Hate Speech". The dataset is loaded into a pandas 
...
# Model Training:
  ...
  #### GUI Implementation: The GUI is implemented using tkinter and includes the following components:
